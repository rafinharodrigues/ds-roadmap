# Exercise: 5. Testar factory methods: Person.from_birth_year('João', 1990)
...
class Person():
    ...
    @classmethod
    def from_birth_year(cls, name: str, birth_year: int) -> object:
...
person1 = Person.from_birth_year(name='João', birth_year=1990)
