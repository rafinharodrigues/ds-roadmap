# Exercise: 15. Criar classe CustomList com todos métodos container
...
class CustomList:
    ...
    def __setitem__(self, item: Any, index: int) -> Any:
        """Set an item to the given index."""
        valueReplaced = self.data[index]
