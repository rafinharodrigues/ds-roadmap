# Exercise: 8. Implementar função draw_shape(shape) que funciona com qualquer forma
...
mixed_shapes = [Circle('circle', 5), Rectangle('rectangle', 3, 4), Triangle('triangle', 3, 4, 5)]

for shape in mixed_shapes:
    print(f'{shape.__class__.__name__} = {shape.calculate_area()}') 
    shape.draw_shape()